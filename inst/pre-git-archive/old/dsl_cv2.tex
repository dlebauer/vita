...
7/97--8/01 & Laboratory and Field Technician, Duke University & \\
\end{tabular}
\end{table}
...
\csznote{ % Stanley Fish's theory on teaching responsibilities NYT 20061023:
introduce students to materials they didn't know a whole lot about,
and 2) to equip them with the skills that will enable them, first, to
analyze and evaluate those materials and, second, to perform
independent research, should they choose to do so, after the semester
is over
} % end csznote
...
\dslnote{%no manuscripts in preparation
...
\csznote{ 
\textbf{FIELD EXPERIENCE}
\begin{itemize*}
\item Channeled Scablands, Washington (2002, loess)
\item Chamrousse, Col du~Lautaret, and Col de~Porte, France (2008, snow-pit sampling)
\end{itemize*}
...
\item Mary Greas 6/06--7/09  (Kearney Undergraduate Fellow) %, UCI Excellence in Research Program)
...
\item Reviewer, Geophys. Res. Lett., Ecology, Plant Soil, Appl. Soil Ecology % need to maintain official count
