...
\ind James Keirstead. 2014. ``Fit for purpose? Rethinking modeling in industrial ecology?'' \emph{Journal of Industrial Ecology}. Accepted.
...
% Energy Systems conference abstract with Sara Walker
...
\ind James Keirstead. 2014. ``decctools: tools for accessing UK energy statistics''. R package version 0.1.5, \url{http://cran.r-project.org/web/packages/decctools/}.
...
%
% \ind 2013.  ``Title''.  Gordon Research Conference on Industrial Ecology, June.
...
%\medskip
%
% Climate KIC - Modelling City Systems
% Climate KIC - Smart Sustainable Districts
% Chris Kennedy's urban metabolism work
% EPSRC Sponsorship Award?
% Future Cities Catapult
% Foresight Cities
% UK-US Network: Arizona
% UK-US Network: Minnesota
%
...
% \ind 2013 Invited participant.  EPSRC Engineering Leaders of the Future? October, Outside Birmingham.
