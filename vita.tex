...
%\ind Paul Rutter and James Keirstead.  In review. ``A brief history and the possible future of urban energy systems'' in \emph{Energy Policy}.

\ind James Keirstead and Aruna Sivakumar. Accepted. ``Using activity-based modeling to simulate urban resource demands at high spatial and temporal resolutions'' in \emph{Journal of Industrial Ecology}.

\ind James Keirstead, Mark Jennings, and Aruna Sivakumar. Accepted. ``A review of urban energy system models: approaches, challenges, and opportunities'' in \emph{Renewable and Sustainable Energy Reviews}.

\ind James Keirstead, Nouri Samsatli, A.\ Marco Pantaleo, and Nilay Shah. In press. ``\href{http://dx.doi.org/10.1016/j.biombioe.2012.01.022}{Evaluating biomass energy strategies for a UK eco-town with an MILP optimization model}'' in \emph{Biomass and Bioenergy}.
...
\ind 2011--present. Technical committee member, CIBSE ASHRAE Technical Symposium 2012.

\ind 2012. Programme committee member, 3rd International Workshop on Agent Technologies for Energy Systems.
