...
%
%\ind M.\ Chester et al. 2014. ``Positioning Infrastructure and Technologies for Low-carbon Urbanization.'' \emph{Earth's Future}, submitted.
%
% \ind R.\ Koppelaar, J.\ Keirstead, J.\ Woods, N.\ Shah. 2014. ``Electricity system model capabilities to perform scenario exercises for policy analysis'' \emph{Energy Policy}, submitted.
...
% Stefan's IQ-SCENE abstract (invited talk)
% Stefan's Energy Systems conference abstract (poster)
% Energy Systems conference abstract with Sara Walker (poster)
