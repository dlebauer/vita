...
\ind Stefan Pfenninger, Adam Hawkes, and James Keirstead. 2014. ``\href{http://dx.doi.org/10.1016/j.rser.2014.02.003}{Energy systems modeling for twenty-first century energy policy}'' \emph{Renewable and Sustainable Energy Reviews}, 33: 74--86.

\ind James Keirstead. 2014. ``\href{http://dx.doi.org/10.1111/jiec.12093}{Fit for purpose? Rethinking modeling in industrial ecology?}'' \emph{Journal of Industrial Ecology}. Accepted.
...
%
% \ind 2014.  ``Title''.  Gordon Research Conference on Industrial Ecology, June.
