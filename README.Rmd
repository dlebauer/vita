...
This has a lot of hacks. I don't recommend using this repository as a starting point for a new CV. There are many new, more flexible, and better looking approaches. But if you really want to fiddle around, please migrate this to one of the newer approaches!
